...
HD_PWD='C:/Users/dora_/controlador_vga_sim/controlador_vga_sim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log controlador_vga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source controlador_vga.tcl
