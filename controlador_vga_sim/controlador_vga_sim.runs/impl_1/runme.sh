...
HD_PWD='C:/Users/dora_/controlador_vga_sim/controlador_vga_sim.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log controlador_vga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source controlador_vga.tcl -notrace
