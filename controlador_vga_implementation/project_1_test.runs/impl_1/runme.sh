...
HD_PWD='C:/Users/dora_/project_1_test/project_1_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log controlador_vga_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source controlador_vga_VIO.tcl -notrace
