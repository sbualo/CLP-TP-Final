...
HD_PWD='C:/Users/dora_/project_1_test/project_1_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log controlador_vga_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source controlador_vga_VIO.tcl
